...
env = PolarizationSplitter_env(config=config_train["env_config"])

trainer.restore('/home/centos/PBS_ML/checkpoints/checkpoint_000100_final')
done = False
